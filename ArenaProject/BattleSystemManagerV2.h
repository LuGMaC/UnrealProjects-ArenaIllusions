...
#include "BattleSystemManagerV2.generated.h"

UCLASS()
class ARENAPROJECT_API ABattleSystemManagerV2 : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ABattleSystemManagerV2();
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Field Effect")
	float MaxSP_Modifier;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Field Effect")
	float CurrentSP_Modifier;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Field Effect")
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Battle Participants")
		TMap<FName, TSubclassOf<class ACombatCharacterV2>> AlliesMap;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Battle Participants")
		TArray<ACombatCharacterV2*> Allies;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Battle Participants")
		TArray<FName> AlliesNames;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Battle Participants")
		TMap<FName, TSubclassOf<ACombatCharacterV2>> EnemyMap;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Battle Participants")
		TArray<ACombatCharacterV2*> Enemies;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Battle Participants")
		TArray<FName> EnemiesNames;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Battle Participants")
		class AMainPlayerControllerV2* PlayerControllerReference;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Battle Turn Order")
		TArray<ACombatCharacterV2*> TurnOrder;
...
public:	
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Battle Setup")
	void SetupCharacterStatus(ACombatCharacterV2* CharacterToSetupStatus);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Combat Function")		
	void ActionStart(ACombatCharacterV2* CharacterToAct);
	...
	UFUNCTION(BlueprintCallable, Category = "Combat Function")
	void AssignNewTarget(ACombatCharacterV2* CharacterToAssignNewTarget);
	...
	UFUNCTION(BlueprintCallable, Category = "Combat Function")
	void SortRandomTarget(ACombatCharacterV2* CharacterToAssignNewTarget);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Combat Function")
	void CheckAllOpponentsForCountersAndBlocks(ACombatCharacterV2* CharacterThatActivatedSkill);

	UFUNCTION(BlueprintCallable, Category = "Combat Function")
	void DamageAllOpponents(bool IsAnAlly, int CalculatedDamageFromAttackingCharacter, ACombatCharacterV2* AttackingCharacter);
